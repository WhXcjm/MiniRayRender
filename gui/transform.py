...
class TransformConfigDialog(QDialog):
	def __init__(self, obj: Object, callback, parent=None):
		...
		self.rotation_x_slider.setRange(-360, 360)
		self.rotation_x_slider.setValue(int(rotation[0]))
		self.rotation_x_slider.setTickInterval(60)
		...
		self.rotation_y_slider.setRange(-360, 360)
		self.rotation_y_slider.setValue(int(rotation[1]))
		self.rotation_y_slider.setTickInterval(60)
		...
		self.rotation_z_slider.setRange(-360, 360)
		self.rotation_z_slider.setValue(int(rotation[2]))
		self.rotation_z_slider.setTickInterval(60)
